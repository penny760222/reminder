...
class class_do_api{
    ...
    private function _do_exec($_params){
        ...
        switch ($reqMethod) {
            case "GET":
                return Instance::get("reminders")->getRemindersingle($_params);
            case "DELETE":
                return Instance::get("reminders")->delReminder($_params);
            case "PATCH":
                return Instance::get("reminders")->patchReminder($_params);
            default:
